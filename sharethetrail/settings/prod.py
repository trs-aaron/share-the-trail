...
AWS_SES_REGION_NAME = env("SES_S3_REGION", default=AWS_S3_REGION_NAME)
AWS_SES_REGION_ENDPOINT = f'email.{AWS_SES_REGION_NAME}.amazonaws.com'
AWS_SES_ACCESS_KEY_ID = env("SES_AWS_ACCESS_KEY_ID", default=AWS_ACCESS_KEY_ID)
AWS_SES_SECRET_ACCESS_KEY = env("SES_AWS_SECRET_ACCESS_KEY", default=AWS_SECRET_ACCESS_KEY)
